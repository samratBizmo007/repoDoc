<h1 id="delete_major_event">Delete Major Event</h1>
							<!-- API URL -->
							<div class="bs-callout bs-callout-info">
								<h4><?php echo $DOC_URL ?>deleteMajorEvent.json</h4>
							</div>
							...
							<!-- REQUEST METHOD -->
							<h3 id="type43">Type</h3>
							<div class="bs-callout bs-callout-info">
								<h4>Type : <code>POST</code></h4>
							</div>

							<!-- REQUEST PARAMETERS -->
							<h3 id="input43">Input</h3>
							<div class="highlight boderleft">
								<pre >
									<code class="html">
Token:00ebb320dc888d343dd08e4d8c3fa9881535368159
						 	...
						 	<div class="highlight boderleft">
								<pre >
									<code class="html">
token:eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJtYWpvcl9ldmVudF9pZCI6Nzd9.32pT_AbI1X22S83fSHIYX9f1KZaSK_F4xgb2184TWf8				
									</code>
						 	...
						 	<!-- RESPONSE -->
							<h3 id="output43">Output</h3>
							<div class="highlight boderleft">
								<h4 class="colorblue">success</h4>
								<pre >
									<code class="html">
{
    "encript": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdGF0dXMiOjIwMCwibWVzc2FnZSI6Ik1ham9yIGV2ZW50IGhhcyBiZWVuIGRlbGV0ZWQuIn0.LiqWmhLBHg1LIT_U1VkyXqMsxGmNO5-QPbXTv_iN8dE"
}
									</code>
								</pre>
						 	</div>
