<h1 id="delete_reminder">Delete Reminder</h1>
							<!-- API URL -->
							<div class="bs-callout bs-callout-info">
								<h4><?php echo $DOC_URL ?>deleteReminder.json</h4>
							</div>
							...
							<!-- REQUEST METHOD -->
							<h3 id="type41">Type</h3>
							<div class="bs-callout bs-callout-info">
								<h4>Type : <code>POST</code></h4>
							</div>

							<!-- REQUEST PARAMETERS -->
							<h3 id="input41">Input</h3>
							<div class="highlight boderleft">
								<pre >
									<code class="html">
Token:00ebb320dc888d343dd08e4d8c3fa9881535368159
						 	...
						 	<div class="highlight boderleft">
								<pre >
									<code class="html">
token:eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJyZW1pbmRlcl9pZCI6MTA3fQ.ivUntvFRCxSnoRhR0tBSHkTjsgxnav6hNt5YqRherCA				
									</code>
						 	...
						 	<!-- RESPONSE -->
							<h3 id="output41">Output</h3>
							<div class="highlight boderleft">
								<h4 class="colorblue">success</h4>
								<pre >
									<code class="html">
{
    "encript": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdGF0dXMiOjIwMCwibWVzc2FnZSI6IlJlbWluZGVyIGhhcyBiZWVuIGRlbGV0ZWQuIn0.hxtAtg0CW3CARh9GwQNth7NZUoG8iIxCEYpatSa6ODM"
}
