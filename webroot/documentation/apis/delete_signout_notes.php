<h1 id="delete_signout_notes">Delete SignoutNotes</h1>
							<!-- API URL -->
							<div class="bs-callout bs-callout-info">
								<h4><?php echo $DOC_URL ?>deleteSignoutNotes.json</h4>
							</div>
							...
							<!-- REQUEST METHOD -->
							<h3 id="type42">Type</h3>
							<div class="bs-callout bs-callout-info">
								<h4>Type : <code>POST</code></h4>
							</div>

							<!-- REQUEST PARAMETERS -->
							<h3 id="input42">Input</h3>
							<div class="highlight boderleft">
								<pre >
									<code class="html">
Token:00ebb320dc888d343dd08e4d8c3fa9881535368159
						 	...
						 	<div class="highlight boderleft">
								<pre >
									<code class="html">
token:eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzaWdub3V0X25vdGVfaWQiOjk1fQ.ZoN4JWPXI-ay8PUnC_TdFl7HeNAKLs7wddAigqZML9Y				
									</code>
						 	...
						 	<!-- RESPONSE -->
							<h3 id="output42">Output</h3>
							<div class="highlight boderleft">
								<h4 class="colorblue">success</h4>
								<pre >
									<code class="html">
{
    "encript": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdGF0dXMiOjIwMCwibWVzc2FnZSI6IlNpbmdvdXQgbm90ZSBoYXMgYmVlbiBkZWxldGVkLiJ9.FPj4vcUjjR5BAIygU5sBWj7FL98UEApEdMalueaSf_s"
}
									</code>
								</pre>
						 	</div>
