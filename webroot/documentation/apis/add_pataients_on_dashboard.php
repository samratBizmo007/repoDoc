<h1 id="add_pataients_on_dashboard">Add Patients On Dashboard</h1>
							<!-- API URL -->
							...
							<!-- REQUEST METHOD -->
							<h3 id="type31">Type</h3>
							<div class="bs-callout bs-callout-info">
								<h4>Type : <code>POST</code></h4>
							</div>

							<!-- REQUEST PARAMETERS -->
							<h3 id="input31">Input</h3>
							<div class="highlight boderleft">
								<pre >
									<code class="html">
Token:00ebb320dc888d343dd08e4d8c3fa9881535368159
						 	...
						 	<div class="highlight boderleft">
								<pre >
									<code class="html">
token:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbXBsb3llZV9pZCI6MTUsInBhdGllbnRfaWQiOiIxMDcsIDExMCJ9.Y-OoqxsVdlBJX4RTLtMzWNgNxYlXMW-eDl0xEJdpfD4
