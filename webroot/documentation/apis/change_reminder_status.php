<h1 id="change_reminder_status">Change Reminder Status</h1>
							<!-- API URL -->
							<div class="bs-callout bs-callout-info">
								<h4><?php echo $DOC_URL ?>changeReminderStatus.json</h4>
							</div>
							...
							<!-- REQUEST METHOD -->
							<h3 id="type46">Type</h3>
							<div class="bs-callout bs-callout-info">
								<h4>Type : <code>POST</code></h4>
							</div>

							<!-- REQUEST PARAMETERS -->
							<h3 id="input46">Input</h3>
							<div class="highlight boderleft">
								<pre >
									<code class="html">
Token:00ebb320dc888d343dd08e4d8c3fa9881535368159
						 	...
						 	<div class="highlight boderleft">
								<pre >
									<code class="html">
token:eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJyZW1pbmRlcl9pZCI6MTA2LCJzdGF0dXMiOjF9.40QCcZgGshc-3W_59B3hD9gmOl0SI6CrOMh7Mjz63xg				
									</code>
						 	...
						 	<!-- RESPONSE -->
							<h3 id="output46">Output</h3>
							<div class="highlight boderleft">
								<h4 class="colorblue">success</h4>
								<pre >
									<code class="html">
{
    "encript": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdGF0dXMiOjIwMCwibWVzc2FnZSI6IlJlbWluZGVyIHN0YXR1cyBoYXMgYmVlbiBjaGFuZ2VkIHN1Y2Nlc3NmdWxseS4ifQ.mj-8A17AMqjd6MKicU7Jdi5H_oEZjR5ak_Eany7O5KE"
}
									</code>
								</pre>
						 	</div>
