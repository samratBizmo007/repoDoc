<h1 id="edit_patient_detail">Edit Patient Detail</h1>
							<!-- API URL -->
							<div class="bs-callout bs-callout-info">
								<h4><?php echo $DOC_URL ?>editPatientDetail.json</h4>
							</div>
							...
							<!-- REQUEST METHOD -->
							<h3 id="type33">Type</h3>
							<div class="bs-callout bs-callout-info">
								<h4>Type : <code>POST</code></h4>
							</div>

							<!-- REQUEST PARAMETERS -->
							<h3 id="input33">Input</h3>
							<div class="highlight boderleft">
								<pre >
									<code class="html">
Token:00ebb320dc888d343dd08e4d8c3fa9881535368159
						 	...
						 	<div class="highlight boderleft">
								<pre >
									<code class="html">
token:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwYXRpZW50X2lkIjoxMDcsInBhdGllbnRfc3RhdHVzIjoyLCJwbWgiOiJ0aGlzIGlzIiwiZGlhZ25vc2VkX3dpdGgiOiJ0aGlzIGlzIHRlc3RpbmcifQ.aGmQ7HxUWnKTccy39dkCA9T0oZwo9kYCjZcW-P7LFWc
						 	...
						 	<!-- RESPONSE -->
							<h3 id="output33">Output</h3>
							<div class="highlight boderleft">
								<h4 class="colorblue">success</h4>
								<pre >
									<code class="html">
{
    "encript": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdGF0dXMiOjIwMCwibWVzc2FnZSI6IlN1Y2Nlc3MifQ.REcfbFhTjlc5fVHHOsjQU_N5qk2GNq4KxDD00cD4MNY"
}
