<h1 id="create_notes">Create Notes</h1>
							<!-- API URL -->
							<div class="bs-callout bs-callout-info">
								<h4><?php echo $DOC_URL ?>createNotes.json</h4>
							</div>
							...
							<!-- REQUEST METHOD -->
							<h3 id="type26">Type</h3>
							<div class="bs-callout bs-callout-info">
								<h4>Type : <code>POST</code></h4>
							</div>

							<!-- REQUEST PARAMETERS -->
							<h3 id="input26">Input</h3>
							<div class="highlight boderleft">
								<pre >
									<code class="html">
Token:00ebb320dc888d343dd08e4d8c3fa9881535368159
						 	...
						 	<div class="highlight boderleft">
								<pre >
									<code class="html">
token:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwYXRpZW50X2lkIjoxMDcsImVtcGxveWVlX2lkIjoyNzUsImNvbnRlbnQiOiJUaGlzIGlzIHRlc3RpbmcifQ.LYsSvmaCgXbYKYFvjE7BzJRehmANCPJMGCjWL2Lojf4				
									</code>
						 	...
						 	<!-- RESPONSE -->
							<h3 id="output26">Output</h3>
							<div class="highlight boderleft">
								<h4 class="colorblue">success</h4>
								<pre >
									<code class="html">
{
    "encript": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdGF0dXMiOjIwMCwibWVzc2FnZSI6IlBhdGllbnQgbm90ZSBoYXMgYmVlbiBzYXZlZCBzdWNjZXNzZnVsbHkuIn0.50u8aUoi5Gk1BZZpYuMISeUAotFlH3IdmoPA73UKIhI"
}
