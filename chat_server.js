var live = "http://52.77.117.85/daily_doc/v1/apis/chatNotification";
...
var queue = new Queue(queueRef, function(data, progress, resolve, reject) {
  ...
  var params = "receiverId=" + receiverId + "&message=" + message + "&chatId="+chatId + "&senderId="+senderId + "&chatType="+chatType + "&messageType="+messageType + "&senderName="+senderName;
