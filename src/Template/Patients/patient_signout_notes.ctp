...
<div class="modal-dialog modal-lg">
  ...
  <div class="box-header with-border">
  	<h3 class="box-title">Patient Signout Notes</h3>
  </div>
    <!-- /.box-header -->
        ...
        <table class="table table-hover table-vertical-align ajax-pagination layout-fixed">
            ...
            <tbody>
                <?php if(!empty($patient['signout_notes'])) { ?>
                  ...
                  <?php foreach ($patient['signout_notes'] as $patient): ?>
                    <tr role="row">
                        <td>
                        ...
                        <td>
                         ...
                         <td>
                        <?php if(!empty($patient->content) && file_exists(Configure::read('UPLOAD_SIGNOUT_NOTE_PATH').$patient->content)) {?>
                            <audio controls style=" width: 100px;">
                              <source src="<?php echo Configure::read('UPLOAD_SIGNOUT_NOTE_URL').$patient->content; ?>" type="audio/mpeg">
