...
<section class="content-header">
	<h1>
    <?php echo __('Employee Schedules Detail')?>
  </h1>
	<ol class="breadcrumb">
		<li><a href="javascript:void(0);"><i class="fa fa-dashboard"></i><?php echo __('Home'); ?></a></li>
		<li><a href="javascript:void(0);"><?php echo $this->Html->link(__('Employee Schedules'),['controller' => 'EmployeesSchedules', 'action' => 'index']); ?></a></li>
		<li class="active"><?php echo __('Employee Schedules Detail') ?></li>
	</ol>
</section>
