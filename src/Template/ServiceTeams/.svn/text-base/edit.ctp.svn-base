...
<div class="modal-dialog modal-sm modal-sm-450">
    ...
    <div class="box box-primary">
        <!-- /.box-header -->
        <!-- form start -->
        <?php echo $this->Form->create($serviceTeam,['id'=>'service-team-edit']); ?>
...
<script type="text/javascript">    
    ...
    $( "#service-team-edit" ).validate({
        rules: {
            name: {
                remote: {
                    url : "<?php echo $this->Url->build(['controller' => 'ServiceTeams', 'action' => 'checkUniqueServiceTeam']); ?>",
                    type : "post"
                }
            }
        },
