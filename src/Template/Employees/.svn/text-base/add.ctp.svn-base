    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <!-- /.box-header -->
                <!-- form start -->
                <?php echo $this->Form->create($employee,['id'=>'employee-add','type'=>'file']); ?>
                    <div class="box-body">
                    	<div class="form-group">
                            <?php
                                if(!empty($current_user['hospitals']['id'])) {
                                    echo $this->Form->input('hospitals_employees.0.hospital_id',[
                                        'id' => 'hospital_id',
                                        'type' => 'hidden',
                        ...
                        <div class="form-group">
                            ...
                            <div id="photo-preview" class="image-preview" style="background-image: url('<?php echo Configure::read("DEFAULT_USER_IMAGE_URL") ?>');">
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
...
$(function () {
    ...
    $( "#employee-add" ).validate({
        rules: {
            email: {
                remote: {
                    url : "<?php echo $this->Url->build(['controller' => 'Employees', 'action' => 'checkUniqueEmployeeByEmail']); ?>",
                    type : "post"
                }
            },
            password: {
    ...
    $(document).ready(function(){
		$('#department').on("change",function () {
        	...
        	var url = "<?php echo $this->Url->build(['controller' => 'Employees','action' => 'getSubDepartment']); ?>";
